		...
		<div class="relative p-4 w-full max-w-md max-h-full">
			...
			<div class="relative bg-white rounded-lg shadow">
                ...
                <form id="form_update_kuota_link" class="hidden p-4 md:p-5" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="time" class="block mb-2 text-sm font-medium text-gray-900">Batas Waktu Token</label>
						<div class="grid grid-cols-2 gap-2">
							<input placeholder="Type number" type="number" min="0" id="time_expired_token_time" name="time_expired_token[time]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
