...
@section('navbarContent')
    ...
    <div class="p-5 mt-4 bg-gray-50 rounded-lg border shadow">
        ...
        <div class="relative">
            ...
            <input type="date" id="tgl_lahir" class="block w-full p-4 pr-32 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" required>
            <button type="button" id="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Submit</button>
        </div>
    </div>
    <div class="p-5 mt-4 bg-gray-50 rounded-lg border shadow">
