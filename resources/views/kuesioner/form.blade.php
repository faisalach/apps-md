                ...
                <div class="mb-3">
                    ...
                    <div class="bg-white rounded-lg py-3 px-5 mb-3">
                        ...
                        <div class="flex items-center mt-4 mb-2">
                            ...
                            <label for="laki-laki" class="ms-2 text-lg font-medium text-gray-900">Laki-laki</label>
                        </div>
                        <div class="flex items-center mb-2">
                            ...
                            <label for="perempuan" class="ms-2 text-lg font-medium text-gray-900">Perempuan</label>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg py-3 px-5 mb-3">
                        ...
                        <div class="flex items-center mt-4 mb-2">
                            ...
                            <label for="gol_a" class="ms-2 text-lg font-medium text-gray-900">A</label>
                        </div>
                        <div class="flex items-center mb-2">
                            ...
                            <label for="gol_b" class="ms-2 text-lg font-medium text-gray-900">B</label>
                        </div>
                        <div class="flex items-center mb-2">
                            ...
                            <label for="gol_ab" class="ms-2 text-lg font-medium text-gray-900">AB</label>
                        </div>
                        <div class="flex items-center mb-2">
                            ...
                            <label for="gol_o" class="ms-2 text-lg font-medium text-gray-900">O</label>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg py-3 px-5 mb-3">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex items-center mt-4 mb-2">
                                ...
                                <label for="jwb_{{ $jwb->id }}" class="ms-2 text-lg font-medium text-gray-900">
                                    @switch($key)
                                        @case(0)
                                            A.
                                            @break
